...
function App() {
  ...
  const [onLoadingImage, setOnLoadingImage] = useState(true)
  ...
  return (
    <>
      {(onLoadingImage || loadingLogo) && (
        <div className="w-screen h-screen bg-gray-800 z-[10000] flex justify-center items-center fixed">
          <Loading />
        </div>
      )}
      <div className="landing-page" ref={homeRef} id="abc">
        ...
        <div className="landing-page-first-section relative">
          ...
          <img
            src={BgTop}
            onLoad={() => setOnLoadingImage(false)}
            id="bg-top"
        ...
        <div className="landing-page-why-choose-us px-4 md:px-[50px] overflow-hidden">
          ...
          <div className="grid xl:px-[143px] xl:grid-cols-3 grid-cols-1">
            <BenefitItem
              ...
              description={
                <div>
                  ...
                  other risks that threaten them. <br /> <br /> We guarantee stability and
            ...
            <BenefitItem
              ...
              description={
                <div>
                  We are a team of technologists with backgrounds in security, networking,
                  blockchain infrastructure, token economics, and decentralized finance. <br />{" "}
                  <br /> Our infrastructure is housed in highly secure data centers around the
                  world. We are constantly building redundancy into our infrastructure to ensure
                  perpetual node coverage and network uptime.
                </div>
              }
            />
            <BenefitItem
        ...
        <div
          ...
          <div data-aos="fade-up">
            ...
            <div
              className="text-[20px] font-light pb-[60px]"
